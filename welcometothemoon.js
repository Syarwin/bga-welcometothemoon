...
define([
  ...
  return declare(
    ...
    [customgame.game, welcometothemoon.players, welcometothemoon.cards, welcometothemoon.scribbles],
    {
      ...
      formatString(str) {
        const ICONS = ['ARROW', 'ROCKET', 'SABOTAGE', 'X', 'SYSTEM-ERROR', 'RESHUFFLE', 'ENERGY'];
      ...
      setupInfoPanel() {
        ...
        let hamburgerMenu = $('ingame_menu_content');
        let menuPrefs = [...hamburgerMenu.querySelectorAll('.preference_choice')];
        menuPrefs[menuPrefs.length - 1].insertAdjacentHTML(
          'afterend',
        ...
        $('more-settings').addEventListener('click', () => this._settingsModal.show());
      },
