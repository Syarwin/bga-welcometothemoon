...
namespace Bga\Games\WelcomeToTheMoon\Core\Engine;
...
class AbstractNode
{
  ...
  public function insertAsBrother($newNode)
  {
    ...
    if (!$this->parent instanceof \Bga\Games\WelcomeToTheMoon\Core\Engine\SeqNode) {
      $newParent = new \Bga\Games\WelcomeToTheMoon\Core\Engine\SeqNode([], []);
  ...
  public function choose($childIndex, $auto = false)
  {
    ...
    if (!$auto && !($child instanceof \Bga\Games\WelcomeToTheMoon\Core\Engine\LeafNode)) {
