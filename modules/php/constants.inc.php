...
const CROSS_SYMBOL_PLANT_ON_PLANET_AND_SHEET = 11;
const CROSS_SYMBOL_WATER_ON_PLANET_AND_SHEET = 12;
const CROSS_SYMBOL_PLANT_ON_SHEET = 13;
const CROSS_SYMBOL_WATER_ON_SHEET = 14;
const CIRCLE_INSIGNIA_ON_ASTEROID = 15;
